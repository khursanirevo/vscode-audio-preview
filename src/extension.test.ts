...
describe('Extension Activation', () => {
  ...
  describe('activate function', () => {
    ...
    it('should get extension information', () => {
      ...
      expect(vscode.extensions.getExtension).toHaveBeenCalledWith('sukumo28.wav-preview');
    });
    ...
    it('should register AudioPreviewEditorProvider', () => {
      ...
      expect(AudioPreviewEditorProvider.register).toHaveBeenCalledWith(mockContext);
    });

    it('should add editor provider to subscriptions', () => {
      const mockDisposable = { dispose: jest.fn() };
      (AudioPreviewEditorProvider.register as jest.Mock).mockReturnValue(mockDisposable);
    ...
    it('should handle missing extension gracefully', () => {
      ...
      expect(console.log).toHaveBeenCalledWith('extension.extensionKind', undefined);
    });
    ...
    it('should handle extension without packageJSON', () => {
      ...
      (vscode.extensions.getExtension as jest.Mock).mockReturnValue(extensionWithoutPackageJSON);
    ...
    it('should handle extension without version in packageJSON', () => {
      ...
      (vscode.extensions.getExtension as jest.Mock).mockReturnValue(extensionWithoutVersion);
  ...
  describe('Extension Environment', () => {
    it('should log UI kind correctly', () => {
      ...
      expect(console.log).toHaveBeenCalledWith('vscode.env.uiKind', vscode.UIKind.Desktop);
    });
    ...
    it('should log remote name correctly', () => {
      ...
      expect(console.log).toHaveBeenCalledWith('vscode.env.remoteName', 'ssh-remote');
    });
  ...
  describe('Extension Metadata Validation', () => {
    ...
    it('should handle different extension kinds', () => {
      ...
      testCases.forEach(kind => {
        ...
        (vscode.extensions.getExtension as jest.Mock).mockReturnValue(extensionWithKind);
        
        activate(mockContext);
        
        expect(console.log).toHaveBeenCalledWith('extension.extensionKind', kind);
      });
    });
    ...
    it('should handle extension with valid packageJSON structure', () => {
      ...
      (vscode.extensions.getExtension as jest.Mock).mockReturnValue(extensionWithComplexPackageJSON);
