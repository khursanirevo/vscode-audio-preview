      ...
      <div class="playerComponent">
        ...
        <div id="playbackRateBox">
          ...
          <select id="playbackRate" name="playbackRate">
            ...
            <option value="0.250">0.25x</option>
            <option value="0.500">0.5x</option>
            <option value="0.750">0.75x</option>
            <option value="1.000">1.0x</option>
            <option value="1.500">1.5x</option>
            <option value="2.000">2.0x</option>
          </select>
        </div>
      </div>
    `;
