...
describe('useVSCode Hook', () => {
  const mockVSCodeValue: VSCodeContextType = {
    postMessage: jest.fn(),
    config: { autoAnalyze: true, playerDefault: undefined, analyzeDefault: undefined } as Config,
  ...
  it('should return VSCode context value when within provider', () => {
    const wrapper = ({ children }: { children: React.ReactNode }) =>
      React.createElement(VSCodeContext.Provider, { value: mockVSCodeValue }, children);
  ...
  it('should throw error with undefined context', () => {
    const wrapper = ({ children }: { children: React.ReactNode }) =>
      React.createElement(VSCodeContext.Provider, { value: undefined }, children);
  ...
  it('should provide access to all context properties', () => {
    ...
    const wrapper = ({ children }: { children: React.ReactNode }) =>
      React.createElement(VSCodeContext.Provider, { value: fullContext }, children);
