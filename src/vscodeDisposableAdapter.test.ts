...
import {
  VSCodeDisposableAdapter,
  toIDisposable,
} from "./vscodeDisposableAdapter";
...
describe("VS Code Disposable Adapter", () => {
  ...
  describe("toIDisposable Helper Function", () => {
    ...
    it("should be convenient for VS Code integration", () => {
      ...
      const _context = (vscode as any).createMockExtensionContext();
  ...
  describe("Integration with Custom Disposable System", () => {
    ...
    it("should support mixed disposable types", () => {
      ...
      disposables.push(
        toIDisposable(vscode.commands.registerCommand("test", () => {})),
      ); // Real VS Code disposable
